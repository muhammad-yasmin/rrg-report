		...
		foreach ($ex as $key) {
			?>
				<tr>
					...
					<td>
						<button class="btn btn-xs btn-pure" title="Lihat Grafik" data-target=".example-modal-lg" data-toggle="modal" onclick="preview('<?php echo $key['namaItem']; ?>',0,'<?php echo $from; ?>','<?php echo $to; ?>');">
