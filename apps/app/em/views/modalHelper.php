...
<div class="modal fade modal-super-scaled" id="modalSiteConfig" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
		...
		<form autocomplete="off" id="formnya" method="post" enctype="multipart/form-data" action="models/prosesUpload.php" target="iframe_upload">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Buat Site Baru</h4>
				</div>
...
<!-- <div class="modal fade modal-fill-in" id="exampleFillIn" aria-hidden="false" aria-labelledby="exampleFillIn" role="dialog" tabindex="-1"> -->
	<div class="modal-dialog modal-simple modal-lg">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" id="tutup" class="btn btn-default btn-pure" data-dismiss="modal">Tutup</button>
			</div>
		</div>
	</div>
</div>